...
- candidate.distance_km 超 intent.distance_max_km 时 rationale 须明示已放宽搜索
- 选 restaurant 须匹配 intent.preferred_poi_types 品类（对齐 cuisine，「烧烤」别选火锅）

【用餐时段规则】正餐类（火锅/粤菜/日料/烧烤/川菜/西餐/健康轻食 等）开始时间须落午餐 11:00-13:30 / 晚餐 17:00-20:00 / 夜宵 21:00 后；茶点类（下午茶/咖啡/甜品）可落午后任意时段。避免正餐落非饭点
