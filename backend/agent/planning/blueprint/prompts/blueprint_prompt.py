...
【用餐时段规则】正餐类须落午餐 11:00-13:30 / 晚餐 17:00-20:00 / 夜宵 21:00 后；茶点类（下午茶/咖啡/甜品）可落午后任意
...
【critic_feedback 处理】user 消息含「上次蓝图违规」段时逐条规避（换 target / 改 duration / 增删节点）。「建议范围 X-Y min」时对应节点 duration_min 收敛到该区间。
